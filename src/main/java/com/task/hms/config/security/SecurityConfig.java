    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/**", "/api/users/register", "/swagger-ui.html", "/swagger-ui/",
                                "/swagger-ui/**", "/v3/api-docs", "/v3/api-docs/", "/v3/api-docs/**", "/api-docs",
                                "/api-docs/", "/api-docs/**", "/actuator/health", "/actuator/**")
                        .permitAll()
                        // Allow public appointment endpoints
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/user/doctors", "/api/ipd/wards",
                                "/api/ipd/beds")
                        .permitAll()
                        // TEMP: Allow GET for pharmacy and billing alerts for debugging
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/pharmacy/batches/low-stock",
                                "/api/pharmacy/batches/expiring", "/api/billing/bills/pending")
                        .permitAll()
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/pharmacy/medicines")
                        .hasAnyRole("ADMIN", "PHARMACIST", "NURSE")
                        // Allow POST for adding batches to ADMIN, PHARMACIST, and NURSE roles
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/pharmacy/batches")
                        .hasAnyRole("ADMIN", "PHARMACIST", "NURSE")
                        // Allow PUT for updating batches to ADMIN, PHARMACIST, and NURSE roles
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/pharmacy/batches/**")
                        .hasAnyRole("ADMIN", "PHARMACIST", "NURSE")
                        // Allow POST for recording payments to ADMIN, ACCOUNTANT, and CASHIER roles
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/payments/record")
                        .hasAnyRole("ADMIN", "ACCOUNTANT", "CASHIER")
                        // Restrict updating admissions to ADMIN, DOCTOR, BILLING roles
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/ipd/admissions/**")
                        .hasAnyRole("ADMIN", "DOCTOR", "BILLING")
            ...
            public void addCorsMappings(@NonNull CorsRegistry registry) {
                registry.addMapping("/**")
                        .allowedOrigins(
                                "http://localhost:3000",
                                "http://127.0.0.1:3000",
                                "http://51.21.160.46:3000",
                                "http://ec2-51-21-160-46.eu-north-1.compute.amazonaws.com:3000",
                                "http://hms.51.21.160.46.nip.io:3000")
